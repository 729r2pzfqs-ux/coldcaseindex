...
<meta property="og:image:alt" content="{e(name)} — ColdCaseIndex cold case database">
...
<meta name="twitter:image:alt" content="{e(name)} — ColdCaseIndex cold case database">
...
<link rel="stylesheet" href="../../case-page.css">
